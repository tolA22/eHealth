...
<div class="container">
    <div class="row justify-content-center py-5">
        <div class="d-none d-md-block col-md-6">
            <img id="doc3" src="{{ asset('images/reception.jpg') }}" alt="">
        </div>
        <div class="col-md-6 m-auto">
        <div>
             <h4 class="font-weight-bold text-justify">Welcome to <span class="text-success">eHealth</span> !!</h4>
     
            <p class="py-3 text-secondary text-justify text-md-left">To get started with our services, please register with your personal information </p>
        ...
        <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="dob" class="col-md-4 col-form-label text-md-left">{{ __('Role') }}</label>
